...
3. Review the material on the [DSR-1019 Regression Challenge]()
...
Materials must be submitted by the 11:59pm EST on **Monday, November 16th**.

The last day for the Kaggle competition will be **Sunday,  November 15th**.

Your technical report will be hosted on Github Enterprise. Make sure it includes:

- A README.md (that isn't this file)
- Jupyter notebook(s) with your analysis and models (renamed to describe your project)
- At least one successful prediction submission on [DSIR-1019 Regression Challenge]() --  you should see your name in the "[Leaderboard]()" tab.
- Data files
- Presentation slides
